...
START_TXT = """
Hi, welcome to Save Content Advance Bot, designed to save restricted messages from public/private channels and private groups. First login in bot by /login then send post link.
"""
